...
mongoose.connect('mongodb://localhost/barberPoledb');
    	...
    	console.log("Person")
 				bcrypt.hash(password, Person.salt, function(err, hash){
 					if(hash === Person.password){
 						...
 						//now that we have userid lets see if this user is a league Owner
 			...
 			bcrypt.genSalt(SALT_WORK_FACTOR, function(err, salt){
 				...
 				// send mail with defined transport object
	 				var mailOptions = {
					    ...
					    html: '<b>Thank you for registering with us, you are now apart of the difference </b><p>http://localhost:3030/verify?'+mailId+'<p/>' // html body
					}
